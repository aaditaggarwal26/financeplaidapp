    ...
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
              Card(
                ...
                child: ListTile(
                  title: Text('Current spend this month', style: TextStyle(color: Colors.black)),
                  subtitle: Text('Up X% above last month', style: TextStyle(color: Colors.red)),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {},
                    child: Text('Add Account', style: TextStyle(color: Colors.purple)),
                  ),
                ],
              ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.schedule), label: 'Recurring'),
